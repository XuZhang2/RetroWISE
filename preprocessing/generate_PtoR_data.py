...
if __name__ == '__main__':
    ...
    assert args.dataset in ['USPTO_50K', 'USPTO_full','USPTO-MIT', 'USPTO_extra_mit', 'USPTO_extra_full', 'zinc-20m', 'less-frequency-new']
    print(args)
    if args.test_only:
        datasets = ['test']
    ...
    if args.dataset == "USPTO-MIT":
        ...
        datadir = './dataset/{}'.format(args.dataset)
        savedir = './dataset/{}_PtoR_aug{}_seed{}'.format(args.dataset, args.augmentation, args.seed)
